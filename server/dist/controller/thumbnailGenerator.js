...
export const generateImageThumbnail = async (filePath) => {
...
export const generateVideoPreview = async (filePath) => {
...
export const getImageThumbnail = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Error generating image thumbnail', error: error.message });
    }
};
...
export const getVideoPreview = async (req, res) => {
    ...
    try {
        ...
        res.status(500).json({ message: 'Error generating video preview', error: error.message });
    }
};
